          ...
          {success ? (
            <div className="text-center py-4">
              ...
              <p className="text-sm text-gray-500 leading-relaxed mb-6">
                If an account exists with <span className="font-semibold text-gray-700">{email}</span>, a password reset link has been sent. Please check your inbox and spam folder.
              </p>
              <Link
                href="/login"
                className="inline-flex items-center gap-2 py-3 px-5 rounded-xl text-sm font-semibold text-white bg-[#0072BC] hover:bg-[#005a94] transition-all duration-200 active:scale-[0.98]"
              >
            ...
            <>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div>
                  <label htmlFor="forgot-email" className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">
                    Email Address
                  </label>
